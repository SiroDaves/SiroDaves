      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
        <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
          <h1 className="text-3xl font-bold leading-10 text-white md:font-extrabold lg:text-[2.6rem] lg:leading-[3.5rem]">
            ...
            ,<br />
            and a{" "}
            <Link href={bio.hashnode} target="_blank">
          ...
          <div className="my-12 flex items-center gap-5">
            <Link href={bio.github} target="_blank" className="transition-all text-orange-500 hover:scale-125 duration-300">
              <BsGithub size={30} />
            </Link>
            <Link href={bio.linkedIn} target="_blank" className="transition-all text-orange-500 hover:scale-125 duration-300">
              <BsLinkedin size={30} />
            </Link>
            <Link href={bio.hashnode} target="_blank" className="transition-all text-orange-500 hover:scale-125 duration-300">
              <FaHashnode size={30} />
            </Link>
            <Link href={bio.medium} target="_blank" className="transition-all text-orange-500 hover:scale-125 duration-300">
              <FaMedium size={30} />
            </Link>
            <Link href={bio.blogger} target="_blank" className="transition-all text-orange-500 hover:scale-125 duration-300">
              <FaBlogger size={30} />
            </Link>
            <Link href={bio.youtube} target="_blank" className="transition-all text-orange-500 hover:scale-125 duration-300">
              <FaYoutubeSquare size={30} />
            </Link>
            <Link href={bio.twitter} target="_blank" className="transition-all text-orange-500 hover:scale-125 duration-300">
              <FaTwitterSquare size={30} />
            </Link>
            <Link href={bio.strava} target="_blank" className="transition-all text-orange-500 hover:scale-125 duration-300">
              <FaStrava size={30} />
            </Link>
          </div>
